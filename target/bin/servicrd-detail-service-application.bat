...
%JAVACMD% %JAVA_OPTS%  -classpath %CLASSPATH% -Dapp.name="servicrd-detail-service-application" -Dapp.repo="%REPO%" -Dapp.home="%BASEDIR%" -Dbasedir="%BASEDIR%" com.soso.ServicrdDetailServiceApplication %CMD_LINE_ARGS%
